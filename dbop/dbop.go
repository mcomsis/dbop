...
func anytypeToStr(value interface{}) string {
	switch value.(type) {
		...
		case int8:
			return strconv.FormatInt(value.(int8),10)
		case int16:
			return strconv.FormatInt(value.(int16),10)
		case int32:
			return strconv.FormatInt(value.(int32),10)
		case int64:
			return strconv.FormatInt(value.(int64),10)
		case uint:
			return strconv.FormatUint(value.(uint), 10)
		case uint8:
			return strconv.FormatUint(value.(uint8), 10)
		case uint16:
			return strconv.FormatUint(value.(uint16), 10)
		case uint32:
			return strconv.FormatUint(value.(uint32), 10)
		case uint64:
			return strconv.FormatUint(value.(uint64), 10)
		case float32:
			return strconv.FormatFloat(value.(float32), 'f', -1, 64)
		case float64:
